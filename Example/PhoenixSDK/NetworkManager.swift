...
public class NetworkManager {
    ...
    func postUserSectors(url: String, input: InputSectors, completion: @escaping (Int, String) -> Void) {
        // [http 비동기 방식을 사용해서 http 요청 수행 실시]
        let urlComponents = URLComponents(string: url)
        var requestURL = URLRequest(url: (urlComponents?.url)!)
...
//            print("")
//            print("====================================")
//            print("POST Phoenix User Sectors URL :: ", url)
//            print("POST Phoenix User Sectors 데이터 :: ", input)
//            print("====================================")
//            print("")
