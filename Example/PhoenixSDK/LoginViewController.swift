...
class LoginViewController: UIViewController, UITextFieldDelegate {
    ...
    @IBAction func tapLoginButton(_ sender: UIButton) {
        ...
        if (checkUserInfo(userInfo: userInfo)) {
            ...
            goToVgsController(userInfo: userInfo)
        } else {
    ...
    func goToVgsController(userInfo: UserInfo) {
        guard let vgsVC = self.storyboard?.instantiateViewController(withIdentifier: "VgsViewController") as? VgsViewController else { return }
