...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/KNSDK-UI/KNSDK.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/LocationCocoaPod/KMLocationSDK.framework"
fi
